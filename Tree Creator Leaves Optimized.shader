Shader "HDRPNaturebyCK/Tree Creator Leaves Optimized"
{
    Properties
    {
        [NoScaleOffset] _MainTex("Base (RGB) Alpha (A)", 2D) = "white" {}
[NoScaleOffset] _Shadowtex("Shadow (RGB)", 2D) = "white" {}
[NoScaleOffset] _BumpSpecMap("Normalmap (GA) Spec (R) Shadow Offset (B)", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        VaryingsMeshToDS UnpackVaryingsMeshToDS(PackedVaryingsMeshToDS input)
        {
            ...
            //-------------------------------------------------------------------------------------
                    ...
                    TEXTURE2D(_Shadowtex); SAMPLER(sampler_Shadowtex); float4 _Shadowtex_TexelSize;
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float4 _Property_5F832C8F_Out = _Color;
                        float4 _SampleTexture2D_A94D62BC_RGBA = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.uv0.xy);
                        float _SampleTexture2D_A94D62BC_R = _SampleTexture2D_A94D62BC_RGBA.r;
                        float _SampleTexture2D_A94D62BC_G = _SampleTexture2D_A94D62BC_RGBA.g;
                        float _SampleTexture2D_A94D62BC_B = _SampleTexture2D_A94D62BC_RGBA.b;
                        float _SampleTexture2D_A94D62BC_A = _SampleTexture2D_A94D62BC_RGBA.a;
                        float4 _Multiply_355D69AB_Out;
                        Unity_Multiply_float(_Property_5F832C8F_Out, _SampleTexture2D_A94D62BC_RGBA, _Multiply_355D69AB_Out);
                    
                        float _Property_C79C6211_Out = _Cutoff;
                        surface.Albedo = (_Multiply_355D69AB_Out.xyz);
                        ...
                        surface.Occlusion = 1;
                        surface.Alpha = _SampleTexture2D_A94D62BC_A;
                        surface.AlphaClipThreshold = _Property_C79C6211_Out;
                        return surface;
                    }
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float _SampleTexture2D_A94D62BC_A = _SampleTexture2D_A94D62BC_RGBA.a;
                        surface.Alpha = _SampleTexture2D_A94D62BC_A;
                        surface.AlphaClipThresholdDepthPrepass = 1;
                        return surface;
                    }
