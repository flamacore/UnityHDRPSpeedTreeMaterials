Shader "HDRPNaturebyCK/Tree Creator Leaves"
{
    Properties
    {
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float4 _Property_956BCA7A_Out = _MainColor;
                        float4 _SampleTexture2D_25F34A44_RGBA = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.uv0.xy);
                        float _SampleTexture2D_25F34A44_R = _SampleTexture2D_25F34A44_RGBA.r;
                        float _SampleTexture2D_25F34A44_G = _SampleTexture2D_25F34A44_RGBA.g;
                        float _SampleTexture2D_25F34A44_B = _SampleTexture2D_25F34A44_RGBA.b;
                        float _SampleTexture2D_25F34A44_A = _SampleTexture2D_25F34A44_RGBA.a;
                        float4 _Multiply_178CD924_Out;
                        Unity_Multiply_float(_Property_956BCA7A_Out, _SampleTexture2D_25F34A44_RGBA, _Multiply_178CD924_Out);
                    
                        float4 _SampleTexture2D_CDDE1F36_RGBA = SAMPLE_TEXTURE2D(_BumpMap, sampler_BumpMap, IN.uv0.xy);
                        _SampleTexture2D_CDDE1F36_RGBA.rgb = UnpackNormalmapRGorAG(_SampleTexture2D_CDDE1F36_RGBA);
                        float _SampleTexture2D_CDDE1F36_R = _SampleTexture2D_CDDE1F36_RGBA.r;
                        float _SampleTexture2D_CDDE1F36_G = _SampleTexture2D_CDDE1F36_RGBA.g;
                        float _SampleTexture2D_CDDE1F36_B = _SampleTexture2D_CDDE1F36_RGBA.b;
                        float _SampleTexture2D_CDDE1F36_A = _SampleTexture2D_CDDE1F36_RGBA.a;
                        float _Property_D7A26BB0_Out = _Cutoff;
                        surface.Albedo = (_Multiply_178CD924_Out.xyz);
                        surface.Normal = (_SampleTexture2D_CDDE1F36_RGBA.xyz);
                        ...
                        surface.Occlusion = 1;
                        surface.Alpha = _SampleTexture2D_25F34A44_A;
                        surface.AlphaClipThreshold = _Property_D7A26BB0_Out;
                        return surface;
                    }
...
Dependency "OptimizedShader" = "HDRPNaturebyCK/Tree Creator Leaves Optimized"
