Shader "HDRPNaturebyCK/Tree Creator Bark"
{
    Properties
    {
...
[NoScaleOffset] _GlossMap("Gloss (A)", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        VaryingsMeshToDS UnpackVaryingsMeshToDS(PackedVaryingsMeshToDS input)
        {
            ...
            //-------------------------------------------------------------------------------------
                    ...
                    TEXTURE2D(_GlossMap); SAMPLER(sampler_GlossMap); float4 _GlossMap_TexelSize;
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float4 _SampleTexture2D_B633C7A5_RGBA = SAMPLE_TEXTURE2D(_BumpMap, sampler_BumpMap, IN.uv0.xy);
                        ...
                        float4 _SampleTexture2D_3A9148E8_RGBA = SAMPLE_TEXTURE2D(_GlossMap, sampler_GlossMap, IN.uv0.xy);
                        float _SampleTexture2D_3A9148E8_R = _SampleTexture2D_3A9148E8_RGBA.r;
                        float _SampleTexture2D_3A9148E8_G = _SampleTexture2D_3A9148E8_RGBA.g;
                        float _SampleTexture2D_3A9148E8_B = _SampleTexture2D_3A9148E8_RGBA.b;
                        float _SampleTexture2D_3A9148E8_A = _SampleTexture2D_3A9148E8_RGBA.a;
                        float _Property_CE157CF_Out = _Shininess;
                        float _Multiply_6ED6F682_Out;
                        Unity_Multiply_float(_SampleTexture2D_3A9148E8_A, _Property_CE157CF_Out, _Multiply_6ED6F682_Out);
                    
                        surface.Albedo = (_Multiply_1BBCBAF5_Out.xyz);
                        surface.Normal = (_SampleTexture2D_B633C7A5_RGBA.xyz);
                        surface.BentNormal = IN.TangentSpaceNormal;
                        surface.CoatMask = 0;
                        surface.Metallic = 0;
                        surface.Emission = float3(0, 0, 0);
                        surface.Smoothness = _Multiply_6ED6F682_Out;
                        surface.Occlusion = 1;
...
Dependency "OptimizedShader" = "HDRPNaturebyCK/Tree Creator Bark Optimized"
